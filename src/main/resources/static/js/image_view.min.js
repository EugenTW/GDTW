...
function loadImageSequentially(a,f,b){return new Promise(g=>{const d=document.createElement("div");d.classList.add("photo");var c=document.createElement("img");c.src=(new URL(a.imageUrl,window.location.origin)).href;c.alt=a.siName;c.classList.add("gallery-image");c.onerror=function(){this.src="/images/pic_not_found.webp"};c.onload=()=>{g()};if(b){var e=document.createElement("div");e.classList.add("nsfw-mask");e.innerHTML="R15 or R18 Content\x3cbr\x3eNSFW - Click to reveal";e.addEventListener("click",
    ()=>{document.querySelectorAll(".nsfw-mask").forEach(m=>{m.style.display="none"})});d.appendChild(c);d.appendChild(e)}else d.appendChild(c);const h=document.createElement("div");h.classList.add("single-mode-text");h.innerHTML=`Share : ${a.imageSingleModeUrl}`;h.addEventListener("click",function(){copyToClipboard(a.imageSingleModeUrl);showCopiedMessage(h)});c=document.createElement("a");c.classList.add("open-link-button");c.innerHTML="\x26#128269;";c.title="\u539f\u59cb\u5c3a\u5bf8 - Full Size";c.href=
    a.imageUrl;c.target="_blank";c.rel="noopener noreferrer";e=document.createElement("a");e.classList.add("download-link-button");e.innerHTML="\x26#11015;\x26#65039;";e.title="\u4e0b\u8f09\u5716\u7247 - Download";e.addEventListener("click",async m=>{m.preventDefault();try{const l=await (await fetch(a.imageUrl,{mode:"cors"})).blob(),p=URL.createObjectURL(l),n=document.createElement("a");n.href=p;n.download=a.siName||"download.jpg";document.body.appendChild(n);n.click();document.body.removeChild(n);URL.revokeObjectURL(p)}catch(l){console.error("Download failed:",
...
function displaySingleImage(a){const f=document.getElementById("single-photo");f.innerHTML="";var b=a.siEndDate??"N/A",g=a.siTotalVisited??0,d=document.createElement("div");d.classList.add("status-area");d.innerHTML=`Expires on: ${b} | Views: ${g}`;const c=document.createElement("div");c.classList.add("page-url-text");const e=window.location.href;b=new URL(e);c.innerHTML=`Share: ${b.origin+b.pathname}`;c.addEventListener("click",function(){copyToClipboard(e);showCopiedMessage(c)});b=document.createElement("div");
    b.classList.add("photo-url-container");b.appendChild(d);b.appendChild(c);f.appendChild(b);b=document.createElement("div");b.classList.add("photo-wrapper");g=document.createElement("img");d=a.imageUrl.startsWith("http")?a.imageUrl:(new URL(a.imageUrl,window.location.origin)).href;g.src=d;g.alt=a.siName;g.id="photo-img";b.appendChild(g);if(a.siNsfw===1){const h=document.createElement("div");h.classList.add("nsfw-mask");h.textContent="NSFW - Click to reveal";h.addEventListener("click",()=>{h.classList.add("hidden")});
        b.appendChild(h)}f.appendChild(b);a=document.createElement("a");a.classList.add("open-link-button");a.textContent="\x26#128269;";a.title="\u539f\u59cb\u5c3a\u5bf8 - Full Size";a.href=d;a.target="_blank";a.rel="noopener noreferrer";d=document.createElement("a");d.classList.add("download-link-button");d.textContent="\x26#11015;\x26#65039;";d.title="\u4e0b\u8f09\u5716\u7247 - Download";d.addEventListener("click",async h=>{h.preventDefault();try{const k=await (await fetch(image.imageUrl,{mode:"cors"})).blob(),
        m=URL.createObjectURL(k),l=document.createElement("a");l.href=m;l.download=image.siName||"download.jpg";document.body.appendChild(l);l.click();document.body.removeChild(l);URL.revokeObjectURL(m)}catch(k){console.error("Download failed:",k),alert("\u4e0b\u8f09\u5931\u6557! - Download Failed!")}});b=document.createElement("div");b.classList.add("url-container");b.appendChild(a);b.appendChild(d);f.appendChild(b);f.classList.remove("hidden")}
