'use strict';document.addEventListener("DOMContentLoaded",function(){function b(d){const a=document.createElement("div");a.style.position="fixed";a.style.left="50%";a.style.top="50%";a.style.transform="translate(-50%, -50%)";a.style.background="#00FF00";a.style.color="#000000";a.style.padding="15px 20px";a.style.border="2px solid #227700";a.style.borderRadius="5px";a.style.fontSize="16px";a.style.fontWeight="bold";a.style.zIndex="9999";a.style.textAlign="center";a.innerHTML=d;document.body.appendChild(a);
