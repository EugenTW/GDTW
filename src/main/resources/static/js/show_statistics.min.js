'use strict';document.addEventListener("DOMContentLoaded",function(){function d(a){const b=Array(365).fill(null),g=365-a.length;a.forEach((h,f)=>{b[g+f]=h});return b}function c(a,b,g,h){a=document.getElementById(a);a.style.backgroundColor="rgb(29, 2, 29)";a.style.borderRadius="5px";a.style.border="3px solid #7a0a64";a.height=350;a=a.getContext("2d");var f=Math.max(...g.filter(e=>e!==null),5);f=Math.max(f+25,40);new Chart(a,{type:"line",data:{labels:Array(365).fill(""),datasets:[{label:b,data:g,borderColor:h,
