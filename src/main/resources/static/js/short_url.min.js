'use strict';document.addEventListener("DOMContentLoaded",function(){function m(a){return!a||a.length>200?!1:/^https:\/\/[a-zA-Z0-9\-\.]+\.[a-zA-Z]{2,}(:\d+)?(\/.*)?$/.test(a)}function n(){const a=c.value.trim(),d=m(a);h.disabled=!d||a===p}function q(a){navigator.clipboard.writeText(a).then(()=>{l("\u77ed\u7db2\u5740\u5df2\u8907\u88fd\u5230\u526a\u8cbc\u7c3f / The short URL is copied!","darkgreen")}).catch(d=>{console.error("Failed to copy text: ",d);l("\u7121\u6cd5\u8907\u88fd\u77ed\u7db2\u5740 / Unable to copy the short URL.",
    "darkred")})}function l(a,d){const b=document.createElement("div");b.textContent=a;b.style.position="fixed";b.style.top="50%";b.style.left="50%";b.style.transform="translate(-50%, -50%)";b.style.background="#bbfafa";b.style.color="#000000";b.style.border="3px solid #16d4ff";b.style.padding="15px";b.style.borderRadius="5px";b.style.zIndex="9999";b.style.borderWidth="3px";document.body.appendChild(b);setTimeout(()=>{b.style.transition="opacity 0.3s";b.style.opacity=0;setTimeout(()=>b.remove(),300)},
    1500)}const c=document.getElementById("long_url");if(c){function a(d){d.style.height="auto";d.style.height=Math.max(d.scrollHeight,50)+"px"}a(c);c.addEventListener("input",function(){a(this)});c.addEventListener("paste",function(){setTimeout(()=>a(this),0)})}const h=document.getElementById("generate"),f=document.getElementById("shorten_url"),g=document.getElementById("qrcode");let p="";c.addEventListener("input",n);c.addEventListener("paste",function(a){a.preventDefault();a=(a.clipboardData||window.clipboardData).getData("text");
